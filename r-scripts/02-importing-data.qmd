...
#### 3.4.1 Example, but with own google sheet (made in class)

```{r}
#| label: read-google-sheets-data

FactVegComp_link<-"https://docs.google.com/spreadsheets/d/1OTueIpg7aEYII4loNv_8oSgASxMofvk2EFFkRnlgptU/pub?gid=15405617&single=true&output=csv"
...
```{r}
#| label: fig-boxplot
#| fig-cap: Boxplot of the percentage of coverage per species observed. 
